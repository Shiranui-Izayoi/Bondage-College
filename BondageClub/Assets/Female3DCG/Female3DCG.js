...
var AssetFemale3DCG = [
...

	{
		...
		Asset: [
			...
			{ Name: "InteractiveVRHeadset", Difficulty: 6, Value: 80, Time: 6, Random: false, AllowLock: true, DrawLocks: false, Hide: ["ItemNoseNoseRing", "Mask", "Glasses"], Effect: [], AllowEffect: ["BlindHeavy", "Prone"], AllowType: ["VR", "None"], Extended: true, AlwaysExtend: true, Audio: "FuturisticApply", CustomBlindBackground: {"VR" : "SynthWave", "None" : ""},
				Layer: [
